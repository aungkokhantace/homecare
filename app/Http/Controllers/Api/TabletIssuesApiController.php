...
use App\Api\TabletIssues\TabletIssuesApiRepositoryInterface;
...
class TabletIssuesApiController extends Controller
{
    private $repo;

    public function __construct(TabletIssuesApiRepositoryInterface $repo)
    {
        $this->repo = $repo;
    }
