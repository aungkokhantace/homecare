...
use App\Api\Medicalhistory\MedicalhistoryApiRepository;
...
class MedicalhistoryApiController extends Controller
{
    ...
    public function upload(){
        ...
        if($checkServerStatusArray['aceplusStatusCode'] == ReturnMessage::OK){
            ...
            $medicalHistoryId            = $inputAll['id'];

            $medicalHistoryRepo          = new MedicalhistoryApiRepository();
            $medicalHistory              = $medicalHistoryRepo->getObjById($medicalHistoryId);

            if(isset($medicalHistory) && $medicalHistory->id == $medicalHistoryId){

                $paramObj                   = $medicalHistory;
                ...
                $result = $medicalHistoryRepo->update($paramObj);
            }
            else{
                ...
                $result = $medicalHistoryRepo->create($paramObj);
            }
