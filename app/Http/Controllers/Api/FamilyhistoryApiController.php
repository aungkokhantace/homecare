...
use App\Api\Familyhistory\FamilyhistoryApiRepository;
...
class FamilyhistoryApiController extends Controller
{
    ...
    public function upload(){
        ...
        if($checkServerStatusArray['aceplusStatusCode'] == ReturnMessage::OK){
            ...
            $familyHistoryId            = $inputAll['id'];

            $familyHistoryRepo          = new FamilyhistoryApiRepository();
            $familyHistory              = $familyHistoryRepo->getObjById($familyHistoryId);

            if(isset($familyHistory) && $familyHistory->id == $familyHistoryId){

                $paramObj                   = $familyHistory;
                ...
                $result = $familyHistoryRepo->update($paramObj);
            }
            else{
                ...
                $result = $familyHistoryRepo->create($paramObj);
            }
