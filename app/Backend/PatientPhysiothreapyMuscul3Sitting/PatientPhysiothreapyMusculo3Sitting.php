...
namespace App\Backend\PatientPhysiothreapyMuscul3Sitting;

use Illuminate\Database\Eloquent\Model;

class PatientPhysiothreapyMusculo3Sitting extends Model
{
    protected $table = "patient_physiotherapy_musculo_3_sitting";
