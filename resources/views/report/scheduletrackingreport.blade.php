...
@section('title','Schedule Tracking Report')
@section('content')

        <!-- begin #content -->
<div id="content" class="content">

    <h1 class="page-header">Schedule Tracking Report</h1>
    ...
    <div class="row">
        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"></div>
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
            <!-- <button type="button" onclick='schedule_tracking_report_search()' class="form-control btn-primary">Preview</button> -->
            <button type="button" onclick='report_search_with_type("scheduletrackingreport");' class="form-control btn-primary">Preview</button>
        </div>

        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
            <button type="button" onclick='report_export_with_type("scheduletrackingreport");' class="form-control btn-primary">Export Excel</button>
        </div>
    </div>
    <br/>
            ...
            <div class="listing">
                ...
                <table class="table list-table" id="list-table">
                    ...
                    <tr>
                        ...
                        <th class="search-col" con-id="doctor_name">Doctor Name</th>
                        <th class="search-col" con-id="date">Date</th>
                        <th class="search-col" con-id="township">Township</th>
                        <th class="search-col" con-id="preparation duration">Preparation Duration</th>
                        <th class="search-col" con-id="transportation_duration">Transportation Duration</th>
                        <th class="search-col" con-id="treatment_duration">Treatment Duration</th>
                    </tr>
                    </tfoot>
                    <tbody>
                        @foreach($schedule_tracking_array as $key=>$schedule_tracking)
                        <tr>
                            <td><a href="/scheduletrackingreport/schedule_detail/{{$schedule_tracking['schedule_tracking_id']}}">{{$schedule_tracking['patient_name']}}</a></td>
                            <td>{{$schedule_tracking['doctor_name']}}</td>
                            <td>{{$schedule_tracking['date']}}</td>
                            <td>{{$schedule_tracking['township']}}</td>
                            <td>{{$schedule_tracking['preparation_duration']}}</td>
                            <td>{{$schedule_tracking['transportation_duration']}}</td>
                            <td>{{$schedule_tracking['treatment_duration']}}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
