    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <h3 class="panel-title"><strong>Patient Case Summary</strong></h3>
            </div>
            <div class="panel-body">
                <table class="table">
                    <tbody>
                    <tr> <td>{{isset($patient)? $patient->case_scenario:Input::old('case_scenario1')}}</td> </tr>
                    <tr> <td></td> </tr>
                    </tbody>
                </table>
            </div>
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <a class="accordion-toggle accordion-toggle-styled collapsed" data-toggle="collapse" data-parent="#accordion" href="#patientmedicalhistorylist">
                                <i class="fa fa-plus-circle pull-right"></i>
                                Patient Medical History List
                            </a>
                        </h3>
                    </div>
                    <!-- End Panel Heading -->
                    ...
                    <!-- Start Panel Body -->
                    <div id="patientmedicalhistorylist" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="buttons pull-right">
                                        <button type="button" onclick='create_setup_with_patient_id("patientmedicalhistory");' class="btn btn-default btn-md first_btn">
                                            <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                                        </button>
                                        <button type="button" onclick='edit_setup_with_params("patientmedicalhistory");' class="btn btn-default btn-md second_btn">
                                            <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                                        </button>
                                        <button type="button" onclick="delete_setup_with_params('patientmedicalhistory');" class="btn btn-default btn-md third_btn">
                            ...
                            {!! Form::open(array('id'=> 'frm_patientmedicalhistory' ,'url' => 'patientmedicalhistory/destroy', 'class'=> 'form-horizontal user-form-border')) !!}
                            {{ csrf_field() }}
                            <input type="hidden" id="patientmedicalhistory_selected_checkboxes" name="patientmedicalhistory_selected_checkboxes" value="">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="listing">
                                        ...
                                        <table class="table table-striped list-table" id="list-table">
                                            ...
                                            <tr>
                                                <th></th>
                                                <th class="search-col" con-id="medicalHistory">Medical History Name</th>
                                            ...
                                            @foreach($patientmedicalhistories as $patientmedicalhistory)
                                                ...
                                                <tr>
                                                    <td><input type="checkbox" class="check_source" name="patientmedicalhistory_edit_check" value="{{ $patientmedicalhistory->patient_id . '___' . $patientmedicalhistory->medical_history_id }}" id="all"></td>
                                                    <td><a href="/patientmedicalhistory/edit/{{ $patientmedicalhistory->patient_id . '___' . $patientmedicalhistory->medical_history_id }}">{{$patientmedicalhistory->medicalHistory}}</a></td>
                                                    <td></td>
                                                </tr>
    ...
    <div class="row">
        ...
        <div class="panel-group" id="accordion">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <a class="accordion-toggle accordion-toggle-styled collapsed" data-toggle="collapse" data-parent="#accordion" href="#patientfamilyhistorylist">
                            <i class="fa fa-plus-circle pull-right"></i>
                ...
                <!-- Start Panel Body -->
                <div id="patientfamilyhistorylist" class="panel-collapse collapse">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-10"></div>
                            <div class="col-md-2">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="listing">
                                    <input type="hidden" id="pageSearchedValue" name="pageSearchedValue" value="">
                                    <table class="table table-striped list-table" id="list-table2">
                                        <thead>
                                        <tr>
                                            <th><input type='checkbox' name='check' id='check_all_patientfamilyhistory'/></th>
                                            <th>Family Member</th>
                                            <th>History Name</th>
                                        </tr>
                                        </thead>
                                        ...
                                        <tr>
                                            <th></th>
                                            <th class="search-col" con-id="familyMember">Family Member</th>
                                            <th class="search-col" con-id="familyHistory">History Name</th>
                                        </tr>
                                        </tfoot>
                                        <tbody>
                                        @foreach($patientfamilyhistories as $patientfamilyhistory)
                                            ...
                                            <tr>
                                                <td><input type="checkbox" class="check_source_patientfamilyhistory" name="patientfamilyhistory_edit_check" value="{{ $patientfamilyhistory->patient_id . '___' . $patientfamilyhistory->family_history_id . '___' . $patientfamilyhistory->family_member_id }}" id="all"></td>
                                                ...
                                                <td>{{$patientfamilyhistory->familyHistory}}</td>
                                            </tr>
    ...
    <div class="row">
        ...
        <div class="panel-group" id="accordion">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <a class="accordion-toggle accordion-toggle-styled collapsed" data-toggle="collapse" data-parent="#accordion" href="#patientsurgeryistorylist">
                            <i class="fa fa-plus-circle pull-right"></i>
                            Patient Surgery History List
                        </a>
                    </h3>
                </div>
                <!-- End Panel Heading -->
                ...
                <!-- Start Panel Body -->
                <div id="patientsurgeryistorylist" class="panel-collapse collapse">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-10"></div>
                            <div class="col-md-2">
                                <div class="buttons pull-right">
                                    <button type="button" onclick='create_setup_with_patient_id("patientsurgeryhistory");' class="btn btn-default btn-md first_btn">
                                        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                                    </button>
                                    <button type="button" onclick='edit_setup_with_params("patientsurgeryhistory");' class="btn btn-default btn-md second_btn">
                                        <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                                    </button>
                                    <button type="button" onclick="delete_setup_with_params('patientsurgeryhistory');" class="btn btn-default btn-md third_btn">
                                        <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
                                    </button>
                                </div>
                            </div>
                        ...
                        {!! Form::open(array('id'=> 'frm_patientsurgeryhistory' ,'url' => 'patientsurgeryhistory/destroy', 'class'=> 'form-horizontal user-form-border')) !!}
                        {{ csrf_field() }}
                        <input type="hidden" id="patientsurgeryhistory_selected_checkboxes" name="patientsurgeryhistory_selected_checkboxes" value="">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="listing">
                                    <input type="hidden" id="pageSearchedValue" name="pageSearchedValue" value="">
                                    <table class="table table-striped list-table" id="list-table3">
                                        <thead>
                                        <tr>
                                            <th><input type='checkbox' name='check' id='check_all_patientsurgeryhistory'/></th>
                                        ...
                                        <tr>
                                            <th></th>
                                            <th class="search-col" con-id="description">Surgery Name</th>
                                            <th class="search-col" con-id="created_at">Created Date</th>
                                        </tr>
                                        </tfoot>
                                        <tbody>
                                        @foreach($patientsurgeryhsitory as $surgery)

                                            <tr>
                                                <td><input type="checkbox" class="check_source_patientsurgeryhistory" name="patientsurgeryhistory_edit_check" value="{{ $surgery->id }}" id="all"></td>
                                                <td><a href="/patientsurgeryhistory/edit/{{ $surgery->id }}">{{$surgery->description}}</a></td>
    ...
    <div class="row">
        ...
        <div class="panel-group" id="accordion">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <a class="accordion-toggle accordion-toggle-styled collapsed" data-toggle="collapse" data-parent="#accordion" href="#patientschedulehistorylist">
                            <i class="fa fa-plus-circle pull-right"></i>
                            Patient Schedule History List
                        </a>
                    </h3>
                </div>
                <!-- End Panel Heading -->
                ...
                <!-- Start Panel Body -->
                <div id="patientschedulehistorylist" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="listing">
                                    <input type="hidden" id="pageSearchedValue" name="pageSearchedValue" value="">
                                    <table class="table table-striped list-table" id="list-table4">
                                        <thead>
                                        <tr>
                                        ...
                                        <tr>
                                            <th></th>
                                            <th class="search-col" con-id="id">Schedule ID</th>
                                            <th class="search-col" con-id="enquiry_id">Enquiry ID</th>
                                            <th class="search-col" con-id="date">Date</th>
                                        ...
                                        @foreach($schedules as $schedule)
                                            ...
                                            <tr>
                                                <td></td>
                                                <td>{{$schedule->id}}</td>
                                                <td>{{$schedule->enquiry_id}}</td>
                                                <td>{{$schedule->date}}</td>
                                                <td>{{$schedule->time}}</td>
                                                <td>{{$schedule->car_type_name}}</td>
    ...
    <div class="row">
        ...
        <div class="panel-group" id="accordion">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <a class="accordion-toggle accordion-toggle-styled collapsed" data-toggle="collapse" data-parent="#accordion" href="#patientinvoicelist">
                            <i class="fa fa-plus-circle pull-right"></i>
                ...
                <!-- Start Panel Body -->
                <div id="patientinvoicelist" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="listing">
                                    <input type="hidden" id="pageSearchedValue" name="pageSearchedValue" value="">
                                    <table class="table table-striped list-table" id="list-table5">
                                        <thead>
                                        <tr>
                                            <th><input type='checkbox' name='check'/></th>
                                            <th>Schedule ID</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($schedule->car_type == 1)
                                                        Patient Owned Vehicle
                                                    @elseif($schedule->car_type == 2)
                                                        Rental Vehicle
                                                    @else
                                                        {{$carTypes[$schedule->car_type_id]->name}}
                                                    @endif
                                                </td>
                                                <td>{{$schedule->status}}</td>
    ...
    <div class="row">
        ...
        <div class="panel-group" id="accordion">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <a class="accordion-toggle accordion-toggle-styled collapsed" data-toggle="collapse" data-parent="#accordion" href="#patient_neuro">
                            <i class="fa fa-plus-circle pull-right"></i>
                            Patient Neuro Assessment
                        </a>
                    </h3>
                </div>
                <!-- End Panel Heading -->
                ...
                <!-- Start Panel Body -->
                <div id="patient_neuro" class="panel-collapse collapse">
                    <div class="panel-body">
                        <!-- Start Neuro General -->
    ...
    <div class="row">
        ...
        <div class="panel-group" id="accordion">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <a class="accordion-toggle accordion-toggle-styled collapsed" data-toggle="collapse" data-parent="#accordion" href="#patient_musculo">
                            <i class="fa fa-plus-circle pull-right"></i>
                            Patient Muscular Assessment
                        </a>
                    </h3>
                </div>
                <!-- End Panel Heading -->
                ...
                <!-- Start Panel Body -->
                <div id="patient_musculo" class="panel-collapse collapse">
                    <div class="panel-body">
