...
<div id="content" class="content">
    ...
    <h1 class="page-header">Investigation List</h1>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="buttons pull-right">
                {{--<button type="button" onclick='create_setup("investigation");' class="btn btn-default btn-md first_btn">--}}
                    {{--<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>--}}
                {{--</button>--}}
                <button type="button" onclick='edit_setup("investigation");' class="btn btn-default btn-md second_btn">
                    <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                </button>
                {{--<button type="button" onclick='delete_setup("investigation");' class="btn btn-default btn-md third_btn">--}}
    ...
    {!! Form::open(array('id'=> 'frm_investigation' ,'url' => 'investigation/destroy', 'class'=> 'form-horizontal user-form-border')) !!}
    {{ csrf_field() }}
